...
import com.baiyou.response.CodeMsg;
import com.baiyou.response.ResponseWrapper;
import com.baiyou.response.Result;
import com.baiyou.response.ReturnCode;
...
public class BrandController {
    ...
    @RequestMapping(path = "page", method = {RequestMethod.GET}, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public Result<PageResult<Brand>> queryBrandByPage(
     ...
     * @return
     */
    @DeleteMapping(value = "cid_bid/{bid}", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
     ...
     * @return
     */
    @GetMapping(value = "cid/{cid}", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
