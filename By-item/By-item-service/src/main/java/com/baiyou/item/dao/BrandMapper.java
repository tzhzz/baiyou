...
public interface BrandMapper extends Mapper<Brand>, SelectByIdListMapper<Brand, Long> {
     ...
     * @return
     */
    @Select("SELECT b.* FROM tb_brand b LEFT JOIN tb_category_brand cd ON b.id=cb.brand_id WHERE cb.category_id=#{cid}")
